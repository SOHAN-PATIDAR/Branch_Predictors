...
#define TAGE_NUM_COMPONENTS 4  // 4 tables
...
#define TAGE_ENTRY_SIZE (sizeof(Tag) * (TAGE_NUM_COMPONENTS)) + (sizeof(uint8_t) * TAGE_NUM_COMPONENTS) 
...
public:
    ...
    inline Index get_predictor_index(uint64_t ip, int component);   // helper hash function to index into the predictor table using histories
...
inline uint8_t Tage::get_prediction(uint64_t ip, int comp)
{
    /*
...
inline uint8_t Tage::predict(uint64_t ip)
{
...
inline void Tage::ctr_update(uint8_t &ctr, int cond, int low, int high)
{
    /*
...
inline void Tage::update(uint64_t ip, uint8_t taken)
{
    /*
...
inline Index Tage::get_bimodal_index(uint64_t ip)
{
    /*
...
inline Path Tage::get_path_history_hash(int component)
{
    /*
...
inline History Tage::get_compressed_global_history(int inSize, int outSize)
{
    /*
...
inline Index Tage::get_predictor_index(uint64_t ip, int component)
{
    /*
...
inline Tag Tage::get_tag(uint64_t ip, int component)
{
    /*
...
inline int Tage::get_match_below_n(uint64_t ip, int component)
{
    /*
